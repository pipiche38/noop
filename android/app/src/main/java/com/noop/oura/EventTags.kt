...
enum class OuraEventTag(val raw: Int) {
    ...
    val tier: TrustTier
        get() = when (this) {
            ...
            // fixed-point scales, but nothing has confirmed that `breath` IS a respiratory rate against
            // a respiratory ground truth. Tier B until it tracks a moving truth (#194).
            SLEEP_PERIOD_INFO,
